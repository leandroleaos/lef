      ...
      <div class="modal-body">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input type="date" name="dtlanc" value="<?= date('Y-m-d') ?>">
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="valor_calculado" step="0.01" min="0" placeholder="Com juros/desconto">
          </div>

          <div class="form-group">
            <label>Valor pago (R$)</label>
            <input type="number" name="valor_pago" step="0.01" min="0" placeholder="Valor efetivo">
          </div>

          <div class="form-group full" style="display:flex;gap:1.5rem;align-items:center">
            ...
            <label class="form-check">
              <input type="checkbox" name="gerador_parcela" id="chk-gerador_parcela"> Gerador Parcela
            </label>
